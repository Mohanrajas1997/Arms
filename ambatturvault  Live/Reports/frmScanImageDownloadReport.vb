...
Public Class frmScanImageDownloadReport
    ...
    Private Function CallCholaApi(ByVal ObjScanImage As ScanEntryModel) As String
        ...
        'Dim endPoint As String = "http://192.168.10.11:8601/api/Scan/viewimage" 'old Live Api
        'Dim endPoint As String = "http://192.168.10.22:8605/api/Scan/viewimage" '22 server old Live Api
        Dim endPoint As String = "http://192.168.10.22:8603/api/Scan/viewimage" '23 rename as 22 Current Live Api
