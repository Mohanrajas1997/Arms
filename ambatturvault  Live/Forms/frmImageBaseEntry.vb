...
Public Class frmImageBaseEntry
    ...
    Private Function CallCholaApi(ByVal ObjScanImage As ScanEntryModel) As String
        ...
        'Dim endPoint As String = "http://192.168.0.22:8601/api/Scan/viewimage" 'old Live Api
        'Dim endPoint As String = "http://192.168.10.11:8601/api/Scan/viewimage" 'Till 14-02-2024 old Live Api
        'Dim endPoint As String = "http://192.168.10.22:8605/api/Scan/viewimage" '22 server old Live Api
        Dim endPoint As String = "http://192.168.10.22:8603/api/Scan/viewimage" '23server rename as 22 server Current Live Api
